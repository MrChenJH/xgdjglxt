<template>
    ...
    <el-select v-model="shen" placeholder="请选择省" class="selectwdth">
    <el-option
      v-for="item in info"
      :key="item.name"
      :label="item.name"
 ...
 <el-select v-model="shi" placeholder="请选择城市" class="selectwdth">
    <el-option
      v-for="item in citys"
      :key="item.name"
      :label="item.name"
   ...
   <el-select v-model="quxian" placeholder="请选择区县" class="selectwdth">
    <el-option
...
export default {
  ...
  computed:{
      citys(){ 
          let t=this.info.find(t=>t.name==this.shen)
          if(t)
          return this.info.find(t=>t.name==this.shen).city
          else
          return []
      },
      districts(){ 
          let d= this.citys.find(t=>t.name==this.shi)
          if(d)
          return d.district
          else
          return []
