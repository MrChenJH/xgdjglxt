...
<el-row  :gutter="20">
    <el-col :span="24" > 
     <el-table :data="showData"  border fit highlight-current-row style="width: 100%" >
      ...
      <el-table-column  label="计划编号" align="center"  min-width="100px" >
       <template slot-scope="scope"> 
         <span >{{scope.row.jhbh}}</span>
        </template>
      </el-table-column>
       
      <el-table-column  label="获得金豆" align="center"  min-width="150px" >
       <template slot-scope="scope"> 
         <span >{{scope.row.hdjd}}</span>
        </template>
      </el-table-column>
          
        <el-table-column  label="获得银豆" align="center"  min-width="150px" >
       <template slot-scope="scope"> 
         <span >{{scope.row.hdyd}}</span>
        </template>
      </el-table-column>
       ...
       <template slot-scope="scope"> 
         <span >{{scope.row.rq}}</span>
                                ...
                                <el-table-column  label="周期" align="center"  min-width="150px" >
       <template slot-scope="scope"> 
  ...
  mounted(){  
    ...
    searchObj:{
     ...
     pickerOptions2: {
        ...
        tableData:[
          {jtzh:"张三的家",xgzh:"张思睿",jhbh:"1",hdjd:"10",hdyd:"10",rq:"2018/7/2",zq:"周一"},  
          {jtzh:"张三的家",xgzh:"张思睿",jhbh:"2",hdjd:"15",hdyd:"15",rq:"2018/7/2",zq:"周一"}         ]
       }
    }
  }
</script>
