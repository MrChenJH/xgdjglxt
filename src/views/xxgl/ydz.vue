...
<el-row  :gutter="20">
    <el-col :span="24" > 
     <el-table :data="showData"  border fit highlight-current-row style="width: 100%" >
      ...
      <el-table-column  label="家庭豆类型" align="center"  >
       <template slot-scope="scope"> 
         <span >{{scope.row.jtdlx}}</span>
        </template>
      </el-table-column>

      <el-table-column  label="变动时间" align="center"  min-width="100px" >
       <template slot-scope="scope"> 
         <span >{{scope.row.bdsj}}</span>
        </template>
      </el-table-column>
       
      <el-table-column  label="变动事由" align="center"  min-width="150px" >
       <template slot-scope="scope"> 
         <span >{{scope.row.bdsy}}</span>
        </template>
      </el-table-column>
          
        <el-table-column  label="豆值" align="center"  min-width="150px" >
       <template slot-scope="scope"> 
         <span >{{scope.row.dz}}</span>
        </template>
      </el-table-column>

                 <el-table-column  label="收/支" align="center"  min-width="150px" >
       <template slot-scope="scope"> 
         <span >{{scope.row.sz}}</span>
        </template>
      </el-table-column>
  ...
  mounted(){  
    ...
    searchObj:{
     ...
     pickerOptions2: {
        ...
        tableData:[
          {jtzh:"张三的家",jtdlx:"开心豆",bdsj:"2018/7/6",bdsy:"举办线下活动",dz:"10",sz:"收"},  
          {jtzh:"张三的家",jtdlx:"知心豆",bdsj:"2018/7/5",bdsy:"举办线下活动",dz:"400",sz:"收"}         ]
       }
    }
  }
</script>
